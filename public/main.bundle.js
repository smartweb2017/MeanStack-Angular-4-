...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__services_company_service__ = __webpack_require__(11);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_company_service__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_company_service__ = __webpack_require__(11);
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                if (_this.user.accounttype === 'staff' ||
                    _this.user.accounttype == 'customer') {
                    if (!_this.user.role) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_company_service__ = __webpack_require__(11);
...
var CustomerComponent = (function () {
    ...
    CustomerComponent.prototype.getAllCompanies = function () {
        ...
        this.companyService.getAllCompanies().then(function (res) {
            ...
            console.log(_this.currentCompanies);
        }, function (err) {
            console.log(err);
        });
    };
    ...
    CustomerComponent.prototype.createCompany = function () {
        ...
        this.companyService.createCompany(this.newCompany).then(function (res) {
            _this.currentCompanies.push(res);
        }, function (err) {
            console.log(err);
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_role_service__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_company_service__ = __webpack_require__(11);
...
var CustomerEditComponent = (function () {
    ...
    CustomerEditComponent.prototype.getAllUsers = function () {
        ...
        this.userService.getAllUsers().then(function (res) {
            for (var i = 0; i < Object.keys(res).length; i++) {
                if (res[i].accounttype === 'customer' && res[i].username !== _this.customer.username) {
                    _this.users.push(res[i]);
                }
            }
            var temp = [];
            for (var j = 0; j < _this.users.length; j++) {
                for (var i = 0; i < _this.childs.length; i++) {
                    if (_this.users[j]._id == _this.childs[i]) {
                        temp.push(_this.users[j]);
                    }
                }
            }
            _this.childs = temp;
...
var StaffEditComponent = (function () {
    ...
    StaffEditComponent.prototype.getAllUsers = function () {
        ...
        this.userService.getAllUsers().then(function (res) {
            for (var i = 0; i < Object.keys(res).length; i++) {
                if (res[i].accounttype === 'staff' &&
                    res[i].username !== _this.user.username) {
                    _this.users.push(res[i]);
                }
            }
        }, function (err) {
...
var UsersComponent = (function () {
    ...
    //Get Current Companies
    UsersComponent.prototype.getAllCompanies = function () {
        var _this = this;
        this.companyService.getAllCompanies().then(function (res) {
            _this.currentCompanies = [];
            for (var i = 0; i < Object.keys(res).length; i++) {
    ...
    UsersComponent.prototype.getAllUsers = function () {
        ...
        this.usersService.getAllUsers().then(function (res) {
            ...
            if (_this.user.accounttype === 'customer') {
                _this.usersService.getUserDetails(_this.user.id).then(function (res) {
                    _this.user.child = res['user'].child;
                    for (var i = 0; i < _this.user.child.length; i++) {
                        for (var j = 0; j < _this.users.length; j++) {
                            if (_this.users[j].username === _this.user.child[i]) {
                                _this.childs.push(_this.users[j]);
                            }
                        }
                    }
                }, function (error) {
